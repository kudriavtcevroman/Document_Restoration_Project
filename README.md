...
graph TD;
    ...
    style A fill:#f9f,stroke:#333,text-color:#000,stroke-width:2px
    style B fill:#bbf,stroke:#333,text-color:#000,stroke-width:2px
    style C fill:#ff9,stroke:#333,text-color:#000,stroke-width:2px
    style D fill:#9f9,stroke:#333,text-color:#000,stroke-width:2px
    style E fill:#f99,stroke:#333,text-color:#000,stroke-width:2px
    style F fill:#9ff,stroke:#333,text-color:#000,stroke-width:2px
```
